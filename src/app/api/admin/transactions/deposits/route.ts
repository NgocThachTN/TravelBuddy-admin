...
const BACKEND_ROUTE = "/api/v1/admin/transactions/deposits";
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const e = logAndExtract(err, "GET admin deposit transactions");
    if (e.status === 404) {
      return NextResponse.json({
        ...
        message: "Backend chưa hỗ trợ endpoint giao dịch nạp tiền.",
      });
    }
